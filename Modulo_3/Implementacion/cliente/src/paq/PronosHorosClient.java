...
public class PronosHorosClient{
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            System.out.println("Servidor> Ingrese el host en donde esta el ServidorCliente");  
            System.out.println("Servidor> (localhost)");  
            host = brRequest.readLine();
            System.out.println("Servidor> Ingrese el puerto en esta el ServidorCliente");  
        ...
        try {            
            ...
            while( !exit ){    
                ...
                URL url = new URL("http://"+host+":"+port+"/ws/PronosHoros?wsdl");
            	QName qname = new QName("http://paq/", "PronosHorosImplService");
        	    Service service = Service.create(url, qname);
        	    //QName port_name = new QName("http://sc/", "PronosHorosImplPort");
        		...
        		QName port_name = new QName("http://paq/", "PronosHorosImplPort");
                PronosHoros  pronosHoros = service.getPort(port_name,PronosHoros.class);
                //System.out.println(pronosHoros.getHoroscopo("Libra"));
